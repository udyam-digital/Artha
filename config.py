...
class Settings(BaseSettings):
    ...
    analyst_parallelism: int = Field(default=1, alias="ANALYST_PARALLELISM")
    analyst_min_start_interval_seconds: float = Field(default=65.0, alias="ANALYST_MIN_START_INTERVAL_SECONDS")
