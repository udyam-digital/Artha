...
- Maximum single stock: 12% of portfolio
...
## Current target weights (update as needed)
If target weight is not specified for a stock, default to equal weight
based on number of holdings. Flag this clearly in output.

## Tax awareness (apply when Console tradebook is available)
- Prefer LTCG over STCG — holdings > 1 year get 10% tax vs 15%
- Do not recommend selling a position held for 10-11 months without flagging LTCG proximity
